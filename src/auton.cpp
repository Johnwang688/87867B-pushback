...
namespace bot {
    ...
    namespace autons {
        ...
        void left_7() {
            ...
            dt.coast();
            dt.drive(100, 1500, 50, 160);
            dt.drive_dist(980, 1200, 60, 90, 5, bot::sensors::back_dist);
            ...
            dt.turn_to_heading(150, 300, 60);
            dt.drive(-350, 1000, 60, 160);
            dt.drive_arc(-300, 30, 2000, 50, 100);
            dt.hold();
        ...
        void left_4_3() {
            ...
            dt.drive(600, 1000, 60, -160);
            dt.drive_for(150, 600, 50, -160);
            dt.turn_to_heading(150, 300, 60);
            dt.drive(-380, 1000, 60, 160);
            dt.drive_arc(-350, 30, 2000, 50, 100);
            dt.hold();
            return;
        ...
        void left_4_3_2(){
            ...
            bot::pistons::match_load_piston.set(false);
            dt.drive_dist(500, 1200, 60, 90, 5.0, bot::sensors::back_dist);
            dt.drive(-900, 800, 50, 180);
            bot::motors::intake.spin(vex::forward, 100, vex::percent);
            dt.drive(-500, 500, 50, 180);
            dt.brake();
            vex::task::sleep(1000);
            ...
            dt.drive(1000, 800, 50, 180);
            vex::task::sleep(100);
            dt.drive_for(-250, 1000, 50, 180);
            dt.brake();
            dt.turn_to_heading(-130, 1000, 100);
            dt.coast();
            bot::pistons::match_load_piston.set(false);
            dt.drive(-1200, 2000, 80, -135);
            bot::motors::mid.spin(vex::reverse, 100, vex::percent);
            dt.drive(-200, 1000, 30, -135);
            while (vex::timer::system() - start_time < 14000) {
                vex::task::sleep(5);
            }
        ...
        void right_7() {
            ...
            bot::motors::lower.spin(vex::forward, 100, vex::percent);
            bot::pistons::arm_piston.set(false);
            dt.drive(750, 1500, 60, 20);
            bot::pistons::match_load_piston.set(true);
            dt.drive(-450, 1500, 60, -45);
            bot::pistons::match_load_piston.set(false);
            dt.drive(-150, 1000, 40, -90);
            dt.drive_dist(500, 1500, 50, -90, 3.0, bot::sensors::back_dist);
            dt.coast();
            dt.turn_to_heading(180, 600, 100);
            bot::pistons::match_load_piston.set(true);
        ...
        void right_4() {
            ...
            bot::pistons::arm_piston.set(true);
            bot::motors::lower.spin(vex::forward, 100, vex::percent);
            dt.drive(725, 1000, 80, 20);
            bot::pistons::match_load_piston.set(true);
            dt.drive(-125, 800, 80, -30);
            bot::pistons::match_load_piston.set(false);
            dt.drive_dist(500, 1000, 80, -90, 3, bot::sensors::back_dist);
            dt.turn_to_heading(180, 600, 60);
            ...
            dt.drive(210, 1500, 50, -90);
            bot::motors::intake.stop();
            dt.drive_dist(200, 800, 60, -90, 3.0, bot::sensors::back_dist);
            bot::Controller1.Screen.setCursor(2, 1);
            bot::Controller1.Screen.print("back dist: %.1f", bot::sensors::back_dist.objectDistance(vex::mm));
            bot::pistons::arm_piston.set(true);
            dt.drive(-700, 2000, 50, 173);
        ...
        void sawp_2() {
            ...
            dt.drive(-100, 300, 50, -90);
            dt.drive(-200, 800, 100, -90);
            dt.drive_dist(450, 1500, 70, -90, 5.0, bot::sensors::back_dist);
            dt.turn_to_heading(180, 600, 100);
            bot::pistons::match_load_piston.set(true);
            vex::task::sleep(150);
            dt.drive(500, 850, 50, 180);
            dt.drive(-650, 700, 80, 180);
            bot::motors::intake.spin(vex::forward, 100, vex::percent);
            bot::pistons::match_load_piston.set(false);
            dt.brake();
            dt.drive(-500, 500, 50, 180);
            ...
            dt.drive(200, 800, 40, -90);
            bot::pistons::match_load_piston.set(true);
            dt.turn_to_heading(-90, 500, 60);
            bot::pistons::match_load_piston.set(false);
            dt.drive(1600, 3000, 100, -90);
            bot::pistons::match_load_piston.set(true);
            dt.drive_for(200, 400, 50, -90);
            bot::pistons::match_load_piston.set(false);
            dt.drive(-500, 1000, 60, -135);
            bot::motors::upper.spin(vex::forward, 100, vex::percent);
            bot::motors::mid.spin(vex::reverse, 100, vex::percent);
            vex::task mid_task = vex::task([]() -> int {
                dt.drive(-250, 1000, 30, -135);
                return 0;
            });
            vex::task::sleep(1000);
            bot::pistons::match_load_piston.set(false);
            ...
            dt.drive(900, 2000, 80, -135);
            dt.drive(270, 1000, 80, -90);
            dt.drive_dist_front(425, 800, 50, 270, 5.0, bot::sensors::front_dist);
            dt.brake();
            dt.turn_to_heading(180, 600, 60);
            bot::pistons::match_load_piston.set(true);
            vex::task::sleep(100);
            dt.drive(700, 800, 50, 180);
            vex::task::sleep(100);
        ...
        void skills_80() {
            ...
            bot::sensors::imu.setHeading(270, vex::degrees);
            bot::pistons::arm_piston.set(false);
            dt.drive_dist(450, 2000, 50, -90, 3.0, bot::sensors::back_dist);
            dt.brake();
            dt.turn_to_heading(180, 1000, 100);
            bot::pistons::match_load_piston.set(true);
            vex::task::sleep(500);
