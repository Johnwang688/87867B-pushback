...
namespace bot {
    ...
    namespace autons {
        ...
        void left_4_3() {
            ...
            bot::motors::lower.spin(vex::forward, 100, vex::percent);
            bot::pistons::arm_piston.set(true);
            dt.drive(680, 1500, 60, -15);
            bot::pistons::match_load_piston.set(true);
            dt.drive(-230, 1500, 70, 60);
            bot::pistons::match_load_piston.set(false);
        ...
        void right_7() {
            ...
            dt.drive_dist(180, 1200, 60, -90, 3.0, bot::sensors::back_dist);
            bot::Controller1.Screen.setCursor(2, 1);
            bot::Controller1.Screen.print("back dist: %.1f", bot::sensors::back_dist.objectDistance(vex::mm));
            bot::pistons::arm_piston.set(true);
            dt.drive(-700, 2000, 50, 150);
            dt.hold();
            double end_time = bot::Brain.Timer.time(vex::msec);
            bot::Controller1.Screen.setCursor(3,1);
            bot::Controller1.Screen.print("time taken: %.1f", end_time - start_time);
        ...
        void sawp_2() {
            ...
            dt.drive_dist_front(420, 300, 100, 270, 5, bot::sensors::front_dist);
            dt.brake();
        ...
        void skills_100() {
            ...
            dt.turn_to_heading(90, 800, 100);
            dt.drive(-300, 700, 30, 90);
            dt.drive(-500, 500, 100, 90);
            dt.drive_dist(1200, 1000, 50, 90, 3.0, bot::sensors::back_dist);
            dt.brake();
            dt.turn_to_heading(0, 300, 60);
            dt.drive(800, 1000, 100, 0);
            vex::task::sleep(500);
            dt.drive(-800, 1000, 100, 0);
            dt.turn_to_heading(135, 600, 60);
            dt.drive(400, 600, 100, 135);
            dt.drive(-300, 600, 80, 45);
            bot::motors::mid.spin(vex::forward, 80, vex::percent);
            bot::motors::mid.spin(vex::reverse, 60, vex::percent);
            bot::motors::upper.spin(vex::reverse, 100, vex::percent);
            vex::task::sleep(3000);
            dt.drive(1000, 1000, 100, 0);
            dt.turn_to_heading(90, 300, 60);
            dt.drive(-500, 600, 100, 90);
