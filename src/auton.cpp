...
namespace bot {
    ...
    namespace autons {
        ...
        void left_7() {
            ...
            vex::task piston_down_task = vex::task([]() -> int {
                vex::task::sleep(500);
                bot::pistons::match_load_piston.set(true);
                return 0;
            });
            dt.drive(680, 1000, 80, -10);
            dt.drive(-300, 1000, 80, 40);
            dt.drive_dist(500, 1500, 60, 90, 3.0, bot::sensors::back_dist);
            bot::pistons::match_load_piston.set(false);
            dt.turn_to_heading(180, 600, 60);
            bot::pistons::match_load_piston.set(true);
            vex::task::sleep(100);
            dt.drive(800, 1000, 40, -180);
            dt.drive(-200, 800, 80, -180);
            ...
            dt.turn_to_heading(110, 200, 60);
            dt.drive(220, 600, 80, 110);
            dt.turn_to_heading(178, 300, 60);
            bot::motors::intake.stop();
            ...
            dt.drive(-300, 600, 60, 170);
            dt.drive_dist_front(1450, 5000, 50, 180, 5.0, bot::sensors::front_dist);
            dt.hold();
            /*
            bot::sensors::imu.setHeading(0.0, vex::degrees);
            bot::Controller1.Screen.clearScreen();
        ...
        void left_4_3() {
            ...
            dt.drive(680, 1000, 80, -10);
            dt.drive(-300, 1000, 80, 40);
            dt.drive_dist(520, 1500, 60, 90, 3.0, bot::sensors::back_dist);
            bot::pistons::match_load_piston.set(false);
            dt.turn_to_heading(180, 600, 60);
            dt.drive(-900, 700, 60, 180);
            bot::motors::intake.spin(vex::forward, 100, vex::percent);
            ...
            dt.drive(1000, 800, 50, 180);
            vex::task::sleep(100);
            dt.drive(-50, 800, 30, 180);
            dt.drive(-300, 800, 50, -135);
            dt.coast();
            bot::pistons::match_load_piston.set(false);
            dt.drive(-1000, 1500, 80, -137);
            bot::motors::mid.spin(vex::reverse, 100, vex::percent);
            dt.drive_for(-200, 500, 50, -137);
            dt.brake();
            vex::task::sleep(1000);
            dt.drive(-200, 500, 20, -137);
            bot::motors::mid.stop();
            bot::motors::lower.stop();
            dt.coast();
            dt.drive(200, 800, 30, -137);
            dt.drive(500, 1000, 60, -160);
            dt.drive_for(150, 600, 50, -160);
            dt.turn_to_heading(145, 300, 60);
            dt.drive(-400, 1000, 60, 145);
            bot::pistons::arm_piston.set(true);
            dt.drive_dist_front(1450, 5000, 60, 180, 5.0, bot::sensors::front_dist);
            dt.hold();
            return;
        ...
        void left_4_3_2(){
            ...
            bot::motors::lower.spin(vex::forward, 100, vex::percent);
            bot::pistons::arm_piston.set(true);
            dt.drive(725, 1500, 60, -15);
            bot::pistons::match_load_piston.set(true);
            dt.drive(-425, 1500, 70, 60);
            bot::pistons::match_load_piston.set(false);
            ...
            bot::motors::mid.spin(vex::reverse, 100, vex::percent);
            dt.drive(-200, 1000, 30, -135);
            vex::task::sleep(5000);
            dt.drive(200, 1000, 60, -135);
            dt.drive(-300, 1000, 75, -135);
            dt.hold();
            return;
        }
        ...
        void right_6() {
            ...
            dt.drive(800, 1000, 60, 75);
            bot::pistons::match_load_piston.set(true);
            dt.drive(-500, 1000, 80, 10);
            bot::pistons::match_load_piston.set(false);
            dt.drive_dist(600, 1000, 60, -90, 3, bot::sensors::back_dist);
            dt.brake();
            dt.turn_to_heading(180, 600, 60);
            ...
            dt.drive(210, 1500, 50, -90);
            bot::motors::intake.stop();
            dt.drive_dist(200, 1200, 60, -90, 3.0, bot::sensors::back_dist);
            bot::Controller1.Screen.setCursor(2, 1);
            bot::Controller1.Screen.print("back dist: %.1f", bot::sensors::back_dist.objectDistance(vex::mm));
            bot::pistons::arm_piston.set(true);
            dt.drive(-700, 2000, 50, 173);
            dt.hold();
            double end_time = bot::Brain.Timer.time(vex::msec);
            bot::Controller1.Screen.setCursor(3,1);
            bot::Controller1.Screen.print("time taken: %.1f", end_time - start_time);
        ...
        void right_7() {
            ...
            dt.drive(700, 1000, 80, 20);
            vex::task piston_up_task = vex::task([]() -> int {
                vex::task::sleep(1000);
                bot::pistons::match_load_piston.set(false);
                return 0;
            });
            dt.drive(-350, 1000, 80, -40);
            dt.drive_dist(500, 1500, 60, -90, 3.0, bot::sensors::back_dist);
            dt.turn_to_heading(-180, 600, 60);
            bot::pistons::match_load_piston.set(true);
            vex::task::sleep(100);
            dt.drive(800, 1100, 40, -180);
            dt.drive(-200, 800, 80, -180);
            dt.drive(-450, 1000, 60, -180);
            bot::motors::intake.spin(vex::forward, 100, vex::percent);
            dt.drive(-500, 500, 40, -180);
            ...
            bot::pistons::match_load_piston.set(false);
            vex::task::sleep(2000);
            dt.turn_to_heading(120, 600, 60);
            dt.drive(200, 1000, 80, 120);
            dt.turn_to_heading(180, 600, 60);
            bot::motors::intake.stop();
            bot::Controller1.Screen.setCursor(2, 1);
            bot::Controller1.Screen.print("back dist: %.1f", bot::sensors::back_dist.objectDistance(vex::mm));
            ...
            bot::Controller1.Screen.setCursor(3,1);
            bot::Controller1.Screen.print("time taken: %.1f", end_time - start_time);
            dt.drive_dist_front(1450, 5000, 50, 178, 5.0, bot::sensors::front_dist);
            dt.hold();
            /*
            bot::Controller1.Screen.clearScreen();
            bot::Controller1.Screen.setCursor(1,1);
        ...
        void left_4() {
            ...
            dt.drive(680, 1000, 80, -10);
            bot::pistons::match_load_piston.set(true);
            dt.drive(-500, 900, 50, 40);
            dt.drive(-700, 800, 80, -180);
            bot::pistons::match_load_piston.set(false);
            vex::task outtake = vex::task([]() -> int {
                bot::motors::intake.spin(vex::forward, 100, vex::percent);
                return 0;
            });
            dt.drive(-300, 1000, 40, -180);
            vex::task::sleep(200);
            dt.turn_to_heading(120, 200, 60);
            dt.drive(200, 600, 80, 120);
            dt.turn_to_heading(178, 300, 60);
            bot::motors::intake.stop();
            bot::Controller1.Screen.setCursor(2, 1);
            bot::Controller1.Screen.print("back dist: %.1f", bot::sensors::back_dist.objectDistance(vex::mm));
            ...
            bot::Controller1.Screen.setCursor(3,1);
            bot::Controller1.Screen.print("time taken: %.1f", end_time - start_time);
            dt.drive_dist_front(1450, 2500, 50, 178, 5.0, bot::sensors::front_dist);
            dt.hold();
        }
        ...
        void right_4() {
            ...
            bot::pistons::arm_piston.set(false);
            bot::motors::lower.spin(vex::forward, 100, vex::percent);
            dt.drive(680, 1000, 80, 20);
            bot::pistons::match_load_piston.set(true);
            dt.drive(-900, 900, 60, -50);
            dt.drive(-700, 700, 80, 180);
            bot::pistons::match_load_piston.set(false);
            vex::task outtake = vex::task([]() -> int {
                bot::motors::intake.spin(vex::forward, 100, vex::percent);
                return 0;
            ...
            dt.turn_to_heading(120, 200, 60);
            bot::motors::intake.stop();
            dt.drive(190, 600, 80, 120);
            dt.turn_to_heading(180, 300, 60);
            bot::Controller1.Screen.setCursor(2, 1);
            bot::Controller1.Screen.print("back dist: %.1f", bot::sensors::back_dist.objectDistance(vex::mm));
            bot::pistons::arm_piston.set(true);
            bot::Controller1.Screen.setCursor(2,1);
            ...
            bot::Controller1.Screen.setCursor(3,1);
            bot::Controller1.Screen.print("time taken: %.1f", end_time - start_time);
            dt.drive_dist_front(1450, 2500, 40, 178, 5.0, bot::sensors::front_dist);
            dt.hold();
        }
        ...
        void right_4_2() {
            ...
            bot::pistons::arm_piston.set(true);
            bot::motors::lower.spin(vex::forward, 100, vex::percent);
            dt.drive(775, 1000, 60, 20);
            bot::pistons::match_load_piston.set(true);
            dt.drive(-100, 500, 80, -45);
            bot::pistons::match_load_piston.set(false);
            dt.drive_dist(725, 1000, 80, -90, 3, bot::sensors::back_dist);
            dt.drive(-1000, 1000, 80, -180);
            bot::motors::intake.spin(vex::forward, 100, vex::percent);
            vex::task::sleep(1000);
            dt.turn_to_heading(180, 600, 60);
            dt.drive(100, 800, 30, 180);
            bot::motors::intake.stop();
            bot::pistons::match_load_piston.set(false);
            dt.drive_dist(220, 800, 60, -90, 3.0, bot::sensors::back_dist);
            bot::Controller1.Screen.setCursor(2, 1);
            bot::Controller1.Screen.print("back dist: %.1f", bot::sensors::back_dist.objectDistance(vex::mm));
            bot::pistons::arm_piston.set(true);
            dt.drive(-700, 2000, 50, 173);
        ...
        void sawp_2() {
            ...
            bot::motors::lower.spin(vex::forward, 100, vex::percent);
            dt.drive(150, 300, 35, -90);
            dt.drive(-700, 800, 80, -90);
            dt.drive_dist(480, 800, 40, -90, 5.0, bot::sensors::back_dist);
            dt.turn_to_heading(180, 600, 100);
            bot::pistons::match_load_piston.set(true);
            vex::task::sleep(50);
            dt.drive(500, 800, 50, 180);
            ...
            dt.drive(400, 1000, 80, -90);
            dt.brake();
            dt.drive(750, 1000, 80, -90);
            bot::pistons::match_load_piston.set(true);
            dt.turn_to_heading(-130, 600, 60);
            dt.drive(-300, 400, 70, -130);
            ...
            dt.drive(1000, 1200, 100, -130);
            dt.turn_to_heading(270, 300, 60);
            dt.drive_dist_front(450, 1000, 100, 270, 5, bot::sensors::front_dist);
            dt.brake();
            dt.turn_to_heading(180, 600, 60);
            bot::pistons::match_load_piston.set(true);
            dt.drive(700, 1000, 50, 180);
            dt.drive(-700, 600, 80, 180);
            bot::motors::intake.spin(vex::forward, 100, vex::percent);
            dt.drive(-500, 1000, 30, 180);
            bot::pistons::match_load_piston.set(false);
            double end_time = bot::Brain.Timer.time(vex::msec);
            bot::Controller1.Screen.setCursor(2,1);
            bot::Controller1.Screen.print("end time: %.1f", end_time);
            ...
            bot::Controller1.Screen.setCursor(3,1);
            bot::Controller1.Screen.print("time taken: %.1f", time_taken);
            vex::task::sleep(3000);
            return;
        }
        ...
        void skills_80() {
            ...
            dt.turn_to_heading(-90, 500, 100);
            dt.drive(-300, 700, 50, -90);
            dt.drive_dist(525, 2000, 50, -90, 3.0, bot::sensors::back_dist);
        ...
        void skills_100() {
            ...
            bot::sensors::imu.setHeading(-90, vex::degrees);
            bot::pistons::arm_piston.set(false);
            dt.drive_dist(550, 1500, 50, -90, 3.0, bot::sensors::back_dist);
            dt.brake();
            dt.turn_to_heading(180, 1000, 100);
            bot::pistons::match_load_piston.set(true);
            vex::task::sleep(500);
            ...
            dt.turn_to_heading(-90, 500, 100);
            dt.drive(-300, 700, 50, -90);
            dt.drive_dist(540, 2000, 50, -90, 3.0, bot::sensors::back_dist);
            dt.drive(-800, 1000, 50, 0);
            bot::motors::intake.spin(vex::forward, 100, vex::percent);
            dt.drive(-500, 800, 40, 0);
            dt.brake();
            ...
            dt.brake();
            vex::task::sleep(100);
            dt.turn_to_heading(-70, 600, 60);
            dt.drive(1000, 1500, 100, -85);
            bot::motors::lower.spin(vex::forward, 100, vex::percent);
            dt.turn_to_heading(-90, 600, 60);
            dt.drive(1000, 2000, 100, -90);
            //
            dt.drive_dist(550, 1000, 50, 90, 3.0, bot::sensors::back_dist);
            vex::task::sleep(100);
            dt.turn_to_heading(0, 800, 100);
            bot::pistons::match_load_piston.set(true);
            bot::motors::lower.spin(vex::forward, 100, vex::percent);
